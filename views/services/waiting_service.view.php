...
<head>
    ...
    <title>Megabgh | Waiting Service</title>
...
<body>
    ...
    <main>
        <!--? Hero Start -->
        <div class="slider-area2 section-bg2 hero-overly" data-background="assets/img/hero/personnel-outsourcing.jpg">
            <div class="slider-height2 d-flex align-items-center">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="hero-cap hero-cap2">
                                <h2>Waiting Service</h2>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="services__details__content">
                            ...
                            <div class="services__details__text">
                                    ...
                                    <div class="services__details__chooseus">
                                        ...
                                        <p>
                                        We provide professional waiters for corporate events, parties, weddings, 
                                        funerals and other social gatherings. You can rely on us to support you make your 
                                        event a successful one. We support our clients have a well-organized occasion void of stress.
                                        </p>
                                        <p>
                                        Our servers are trained in general serving techniques and will take care of the setting up, 
                                        serving and the clean-up. We however treat every client differently and work according to 
                                        their special needs.
                                        </p>
                                        <div class="services__details__pic">
                                             <img src="img/services/details/waiting-service.jpg" alt="">
                                         </div>
                        ...
                        <div class="services__sidebar">
                            <div class="services__sidebar__item">
                                ...
                                <ul>
                                    ...
                                    <li><a href="waiting_service" class="service-active">Waiting Service</a></li>
