...
<head>
    ...
    <title>Megabgh | Odour Treatment</title>
...
<body>
    ...
    <main>
        <!--? Hero Start -->
        <div class="slider-area2 section-bg2 hero-overly" data-background="assets/img/hero/odour-control.jpg">
            <div class="slider-height2 d-flex align-items-center">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="hero-cap hero-cap2">
                                <h2>Odour Treatment</h2>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="services__details__content">
                            ...
                            <div class="services__details__text">
                                    ...
                                    <div class="services__details__chooseus">
                                        <h4>Odour Treatment</h4>
                                        <p>
                                        We neutralize offensive odours in schools, offices, hospitals, etc and replace 
                                        them with an agreeable smell.
                                        </p>
                                        
                                        <div class="services__details__pic">
                                             <img src="img/services/details/odour-control.jpg" alt="">
                                         </div>
                        ...
                        <div class="services__sidebar">
                            <div class="services__sidebar__item">
                                ...
                                <ul>
                                    ...
                                    <li><a href="odour_treatment" class="service-active">Odour Treatment</a></li>
