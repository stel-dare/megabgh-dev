...
<head>
    ...
    <title>Megabgh | Artisans Connect Service</title>
...
<body>
    ...
    <main>
        <!--? Hero Start -->
        <div class="slider-area2 section-bg2 hero-overly" data-background="assets/img/hero/artisans-connect.jpg">
            <div class="slider-height2 d-flex align-items-center">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="hero-cap hero-cap2">
                                <h2>Artisans Connect</h2>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="services__details__content">
                            ...
                            <div class="services__details__text">
                                    ...
                                    <div class="services__details__chooseus">
                                        <h4>Artisans Connect</h4>
                                        <p>
                                        We link you up to skilled artisans within proximity in your locality. 
                                        We assist in the easy access to get hold of personnel to solve immediate needs that 
                                        arise in the home.
                                        </p>
                                        
                                        <div class="services__details__pic">
                                             <img src="img/services/details/artisans-connect.jpg" alt="">
                                         </div>
                        ...
                        <div class="services__sidebar">
                            <div class="services__sidebar__item">
                                ...
                                <ul>
                                    ...
                                    <li><a href="artisan_connect"class="service-active">Artisans Connect Service</a></li>
