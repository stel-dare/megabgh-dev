...
<head>
    ...
    <title>Megabgh | Disinfection And Fumigation</title>
...
<body>
        ...
        <div class="header-area">
            <div class="main-header header-sticky">
                ...
                <div class="header-right d-none d-lg-block">
                    ...
                    <a href="#" class="header-btn2">Request For Service</a>
                </div>
                <!-- Mobile Menu -->
                <div class="col-12">
    ...
    <main>
        <!--? Hero Start -->
        <div class="slider-area2 section-bg2 hero-overly" data-background="assets/img/hero/disinfection-fumigation.jpg">
            <div class="slider-height2 d-flex align-items-center">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="hero-cap hero-cap2">
                                <h2> Disinfection And Fumigation</h2>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="services__details__content">
                            ...
                            <div class="services__details__text">
                                    ...
                                    <div class="services__details__chooseus">
                                        ...
                                        <ul>
                                            <li><i class="fa fa-check-circle"></i> Bedbug Fumigation.
                                            </li>
                                        </ul>

                                        <p>
                                        Bedbug populations have developed resistance to insecticides used by professionals and are 
                                        such a difficult pest to control. Spraying pesticides only works if the bugs are directly 
                                        touched by the poison and bedbugs are so small they are not likely to be reached. 
                                        </p>

                                        <p>
                                        However bedbugs are extraordinarily vulnerable to high temperatures. 
                                        Studies have proven that temperatures of over 60ºC are effective in killing bedbugs and
                                         eradicating bedbug infestations. That is why at MEGAB we deploy high steamers to kill both bugs 
                                         and eggs.
                                        </p>
                                        ...
                                        <div class="services__details__pic">
                                             <img src="img/services/details/bedbug-fumigation.png" alt="">
                                         </div>
                                         <ul>
                                            <li><i class="fa fa-check-circle"></i> Disinfection, Fumigation and Odour Neutralization.
                                            </li>
                                        </ul>

                                        <p>
                                        Pathogenic microbes such as virus, fungi and pathogenic bacteria are the main cause of airborne or 
                                        direct contact diseases affecting humans. The application of disinfectants and biocides via fogging
                                         significantly reduce the number of viable infectious pathogens.
                                        </p>
                                            <p>
                                            At MEGAB we use the process of 
                                         thermal fogging to disinfect large internal and external areas, generating
                                         ultra-fine aerosols in a range of 1-50 µm to achieve the needed results. 
                                         Applicable areas include hospitals, schools and offices.
                                            </p>
                                        <div class="services__details__pic">
                                             <img src="img/services/details/disinfection-fumigation-2.jpg" alt="">
                                         </div>
                            ...
                            <!-- <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="services__details__chooseus">
                                        ...
                                        <ul>
                                            <li><i class="fa fa-check-circle"></i> Lorem ipsum dolor sit amet, consectetur.
                                            </li>
                                            <li><i class="fa fa-check-circle"></i> Integer et nisl et massa tempor</li>
                                            <li><i class="fa fa-check-circle"></i> Nunc consectetur ligula placerat tempus.
                                            </li>
                                            <li><i class="fa fa-check-circle"></i> Curabitur quis ante vitae lacus varius
                                                pretium.</li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="services__sidebar">
                            <div class="services__sidebar__item">
                                ...
                                <ul>
                                    ...
                                    <li><a href="disinfection_and_fumigation" class="service-active">Disinfection And Fumigation Service</a></li>
                                    <li><a href="air_scrubbing">Air Scrubbing To Remove Micro Organisms</a></li>
                                    <li><a href="odour_treatment">Odour Treatment</a></li>
                                    <li><a href="waste_water_treatment">Waste Water Treatment</a></li>
                            ...
                            <!-- <div class="services__sidebar__brochure">
                                ...
                                <a href="#" class="primary-btn">Request A Service</a>
                            </div> -->
                            <div class="services__sidebar__help">
                                <!-- <img src="img/services/details/help.jpg" alt=""> -->
                                <h4>Got any questions for us?</h4>
