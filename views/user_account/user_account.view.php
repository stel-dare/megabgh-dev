...
<head>
    ...
    <style>
        /*! CSS Used from: http://localhost:1313/css/style.css */
        body {
            height: 100%;
        ...
        /*! CSS Used from: http://localhost:1313/assets/css/bootstrap.min.css */
        *,
        ::after,
        ::before {
        ...
        /*! CSS Used from: http://localhost:1313/assets/css/slicknav.css */
        .slicknav_btn {
            position: relative;
            display: block;
        ...
        /*! CSS Used from: http://localhost:1313/assets/css/animated-headline.css */
        *,
        *::after,
        *::before {
        ...
        /*! CSS Used from: http://localhost:1313/assets/css/fontawesome-all.min.css */
        .fa,
        .fas {
            -moz-osx-font-smoothing: grayscale;
            -webkit-font-smoothing: antialiased;
        ...
        /*! CSS Used from: http://localhost:1313/css/font-awesome.min.css */
        .fa {
            display: inline-block;
        ...
        /*! CSS Used from: http://localhost:1313/assets/css/style.css */
        ::-webkit-scrollbar {
            width: 5px;
        }
        ...
        /*! CSS Used from: http://localhost:1313/css/shop.css */
        .main-header {
            padding: 1em 0em;
        ...
        .user-account-name:hover>ul.user-account-submenu {
            visibility: visible;
            opacity: 1;
            top: 100%;
        }
        ...
        .user-account-submenu li {
            background: rgba(103, 133, 255, 0.8);
            box-shadow: 0 0 10px 3px rgba(0, 0, 0, 0.05);
            padding: 0.5em 0.8em;
        }

        .user-account-submenu li i {
            padding-right: 0.5em;
        }
        ...
        @font-face {
            ...
            font-weight: 400;
            font-display: swap;
            src: url(https://fonts.gstatic.com/s/overlocksc/v9/1cX3aUHKGZrstGAY8nwVzEGJocWG1-oGmZE.woff2) format('woff2');
        ...
        @font-face {
            ...
            font-weight: 400;
            font-display: swap;
            src: url(https://fonts.gstatic.com/s/overlocksc/v9/1cX3aUHKGZrstGAY8nwVzEGHocWG1-oG.woff2) format('woff2');
            unicode-range: U+0000-00FF, U+0131, U+0152-0153, U+02BB-02BC, U+02C6, U+02DA, U+02DC, U+2000-206F, U+2074, U+20AC, U+2122, U+2191, U+2193, U+2212, U+2215, U+FEFF, U+FFFD;
        }

        @font-face {
            font-family: 'FontAwesome';
            src: url('http://localhost:1313/fonts/fontawesome-webfont.eot?v=4.7.0');
            src: url('http://localhost:1313/fonts/fontawesome-webfont.eot#iefix&v=4.7.0') format('embedded-opentype'), url('http://localhost:1313/fonts/fontawesome-webfont.woff2?v=4.7.0') format('woff2'), url('http://localhost:1313/fonts/fontawesome-webfont.woff?v=4.7.0') format('woff'), url('http://localhost:1313/fonts/fontawesome-webfont.ttf?v=4.7.0') format('truetype'), url('http://localhost:1313/fonts/fontawesome-webfont.svg?v=4.7.0#fontawesomeregular') format('svg');
            font-weight: normal;
            font-style: normal;
        }
                                        ...
                                        <div class="bg-white card addresses-item mb-4 border ">
                                            <div class="gold-members p-4">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <h6 class="mb-1 text-secondary"><?= $address->address_city?></h6>
                                                        <p class="text-black"><?="$address->address, $address->address_city, $address->address_region" ?>
                                                        </p>
