...
<body>
    ...
    <main>
        <!--? Hero Start -->
        <div class="slider-area2 section-bg2 hero-overly" data-background="assets/img/hero/hero4.jpg">
                    ...
                    <div class="col-lg-8 order-lg-2">
                        <div class="services__details__content">
                            ...
                            <div class="services__details__text">
                                ...
                                <p>Having years of diverse experience, we are able to create cutting-edge recommendations
                                    ...
                                    <div class="services__details__chooseus">
                                        <h4>Hotel in-House Training</h4>
                                        <p>
                                            We offer training for hotel staff to gain the relevant skills to work efficiently in:
                                        ...
                                        <ul>
                                            <li><i class="fa fa-check-circle"></i> Housekeeping.
                                            </li>
                                            <li><i class="fa fa-check-circle"></i>   Front Office Management.</li>
                                            <li><i class="fa fa-check-circle"></i>  Floor and carpet care.
                                            </li>
                                            <li><i class="fa fa-check-circle"></i>  Personal Grooming.</li>
                                            <li><i class="fa fa-check-circle"></i>  Safety Management.</li>
                            ...
                            <div class="services__details__pic">
                                <img src="img/services/details/service-details-vii.png" alt="">
                            </div>
                            <!-- <div class="services__details__text">
                                ...
                                <p>
                                    We provide professional waiters for corporate events, parties, weddings, funerals and other social gatherings.
                                     You can rely on us to support you make your event a successful one. We support our clients have a well-organized 
                                     occasion void of stress. Our servers are trained in general serving techniques and will take care of the setting up, 
                             ...
                             <p>
                                Do you need some assistance to move in a new residence or office? Our team will assist to make that move a comfortable one.
                                 We have neat, covered container trucks and vans to transfer your personal belongings from any part of Accra to your new location.
                                  We also do removals for offices, schools, hospitals among other institutions. Our prices are very affordable and we offer reliable 
